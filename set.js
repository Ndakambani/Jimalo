...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~CyZTCJZS#6FJ7M1z5XM98Pb0KTNZ15R6VAiGWAKDSaA3imo6K7yo", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "263771195152", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "263771195152", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "🔐 ANGEL DI MARIA 🔥🔥", // Input Yours custom...(Maintain font for Flow)
...
BOT_NAME: process.env.BOT_NAME || "🔐 ANGEL DI MARIA 🔥🔥", // Input Yours custom...(Maintain font for Flow)
...
global.myName = "james"; // DO NOT Change this.... Change and Regret Later...
