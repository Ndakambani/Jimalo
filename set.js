...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~C742yIpL#2yGYqMxJHLIdT2jXmolSA3uTzdsdo3NvQc9enTxVx2o", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NAME: process.env.OWNER_NAME || "James sigauke ", // Input Yours custom...(Maintain font for Flow)
...
BOT_NAME: process.env.BOT_NAME || "Toyota GD6", // Input Yours custom...(Maintain font for Flow)
